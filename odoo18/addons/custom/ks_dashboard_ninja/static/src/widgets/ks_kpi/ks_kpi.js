    ...
    setup() {
        ...
        ks_changes(){
            ...
            if (field.ks_kpi_data){
                ...
                if (field.ks_target_view === "Progress Bar" && field.ks_goal_enable && field.ks_standard_goal_value && field.ks_model_id_2 && parseInt(target_progress_deviation)){
                    $(this.ks_kpi_ref.el).find('#ks_progressbar').val(parseInt(target_progress_deviation));
                }
                if (field.ks_target_view=== "Progress Bar" && field.ks_goal_enable && field.ks_standard_goal_value && parseInt(target_progress_deviation)) {
                $(this.ks_kpi_ref.el).find('#ks_progressbar').val(parseInt(target_progress_deviation));
            }

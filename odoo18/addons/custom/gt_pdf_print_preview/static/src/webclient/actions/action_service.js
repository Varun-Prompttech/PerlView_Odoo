        ...
        if (action.report_type === "qweb-html") {
            ...
            try {
                ...
                if(session.preview_print) {
                    ...
                    ({ success, message } = await downloadReportCustom(rpc, action, 'pdf', downloadContext));
                }
                else {

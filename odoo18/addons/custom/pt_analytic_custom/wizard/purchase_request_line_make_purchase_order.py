...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    @api.model
    def _prepare_purchase_order(self, picking_type, group_id, company, origin, analytic_account):
        ...
        data = {
            ...
            'analytic_account_id': [(6, 0, analytic_account)]
        }
        return data
        ...
        for item in self.item_ids:
            ...
            if not purchase:
                po_data = self._prepare_purchase_order(
                    ...
                    line.company_id,
                    line.origin,
                    line.request_id.analytic_account_id.ids
                )
